                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="addClient">
                                ...
                                <form method='Post'>
                                    ...
                                    <input name='name' class="AddClient">
                                    <small style="color:red; font-style:italic;"><?php echo (!isset($errors['notesName']))? '' : $errors['notesName'] ?></small>
                                    ...
                                    <textarea name='notes' class="AddClient2"></textarea>
